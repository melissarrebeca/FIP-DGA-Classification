...
if __name__ == "__main__":
    ...
    # for i in range(1, 2):
    file_path = f"./data/training_gases_and_faults_sequential_neural_network.csv"
    ...
    with open("./results/not_discovered.csv", mode='w', newline='') as file:
        writer = csv.writer(file)
        writer.writerows(not_discovered_results)

    with open("./results/right.csv", mode='w', newline='') as file:
        writer = csv.writer(file)
        writer.writerows(right_results)

    with open("./results/wrong_match.csv", mode='w', newline='') as file:
        writer = csv.writer(file)
